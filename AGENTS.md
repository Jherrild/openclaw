...
3.  **Default:** If the user agrees (or established preference implies it), use `sessions_spawn` (Gemini Flash).
...
**The Rule:**
You MUST NOT perform heavy coding, large refactors, or complex technical documentation (PRDs) directly in the Main Session.
...
2.  **Protocol (New Skill):**
    ...
    *   Write PRD: `write skills/<name>/PRD.md` (Capture requirements)
...
4.  **Protocol (General Code):**
    *   Delegate: `copilot -p "INSTRUCTIONS" --model claude-opus-4.5 --allow-all`
